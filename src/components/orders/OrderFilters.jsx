...
export default function OrderFilters({ filters, setFilters, stores }) {
  ...
  return (
    <div className="mb-4 flex flex-wrap items-center gap-3 rounded-2xl border border-slate-100 bg-white p-4">
      ...
      <select
        ...
        className="rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-600 outline-none focus:border-brand-blue"
      >
